...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar gambar" src="../../images/<?php echo $d['gambar']; ?>" alt="User Image">
        <div>
          <p class="app-sidebar__user-name text-white"><?php echo $d['nama_guru']; ?></p>
        </div>
      </div>
      <?php
        }
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="uploadmateri.php"><i class="app-menu__icon fa fa-file-text-o"></i><span class="app-menu__label">Materi</span></a></li>
      </ul>
    </aside>
